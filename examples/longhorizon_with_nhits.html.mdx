...
![](/neural-forecast/examples/LongHorizon_with_NHITS_files/figure-markdown_strict/cell-4-output-1.png)
...
![](/neural-forecast/examples/LongHorizon_with_NHITS_files/figure-markdown_strict/cell-11-output-1.png)
