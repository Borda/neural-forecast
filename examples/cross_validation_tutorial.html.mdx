...
![](/neural-forecast/examples/Cross_Validation_Tutorial_files/figure-markdown_strict/cell-6-output-1.png)
...
![](/neural-forecast/examples/../imgs_indx/predict_insample.png)
...
![](/neural-forecast/examples/Cross_Validation_Tutorial_files/figure-markdown_strict/cell-15-output-1.png)
...
![](/neural-forecast/examples/Cross_Validation_Tutorial_files/figure-markdown_strict/cell-16-output-1.png)

```python
plot_series(Y_df, cv_df[cv_df['cutoff'] == cutoff2].loc[:, cv_df.columns != 'cutoff'], ids=['H1'])
```

![](/neural-forecast/examples/Cross_Validation_Tutorial_files/figure-markdown_strict/cell-17-output-1.png)

```python
plot_series(Y_df, cv_df[cv_df['cutoff'] == cutoff3].loc[:, cv_df.columns != 'cutoff'], ids=['H1'])
```

![](/neural-forecast/examples/Cross_Validation_Tutorial_files/figure-markdown_strict/cell-18-output-1.png)
