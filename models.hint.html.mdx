...
<a
href="https://github.com/Nixtla/neuralforecast/blob/main/neuralforecast/models/hint.py#L186"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
<a
href="https://github.com/Nixtla/neuralforecast/blob/main/neuralforecast/models/hint.py#L214"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
![](/neural-forecast/imgs_models/hint_notation.png)
